...
export async function generateVerificationWorkbook(filters = {}) {
  ...
  const figures = [
    ...
    fig('Closed-won value (gross profit)', f.closedWon, 'Deals', 'Sum "Gross profit EUR" where Status = Won.'),
    fig('Closed-won value (revenue basis)', f.closedWonRevenue, 'Deals', 'Sum "Value EUR" where Status = Won.'),
